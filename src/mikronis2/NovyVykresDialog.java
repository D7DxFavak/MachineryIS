...
public class NovyVykresDialog extends javax.swing.JDialog {
    ...
    public NovyVykresDialog(String cislo, String revize, boolean uprava) {
        this.uprava = uprava;
        initComponents();
        inicializaceKomponent();
        this.setVisible(true);
    ...
    public NovyVykresDialog(int vykres_id, boolean uprava) {
    ...
    public NovyVykresDialog(int vykres_id, boolean uprava, boolean smazat) {
        this.vykres_id = vykres_id;
        this.smazat = smazat;
        this.uprava = uprava;
        initComponents();
    ...
    public TridaVykres1 showDialog() {
        setVisible(true);
        return tv1;
    }
    ...
    private void inicializaceKomponent() {
        ...
        ZakaznikComboBox1.setSelectedIndex(MikronIS2.indexZakaznika);
    }
