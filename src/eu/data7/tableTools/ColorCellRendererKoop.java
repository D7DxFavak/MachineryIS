...
public class ColorCellRendererKoop extends JTextField implements TableCellRenderer {
    ...
    public ColorCellRendererKoop(int[][] index, int[][] index2, Color backColor, Color frontColor) {
        this.index = index;       
        this.index2 = index2;
