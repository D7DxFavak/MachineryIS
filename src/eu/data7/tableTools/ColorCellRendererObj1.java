...
public class ColorCellRendererObj1 extends JTextField implements TableCellRenderer {
    ...
    public ColorCellRendererObj1(int[][] index, int[][] index2, int[][] index3, int[][] index4, int[][] index5, Color backColor, Color frontColor) {
        this.index = index;
        this.index2 = index2;
        this.index3 = index3;
        this.index4 = index4;
...
// component will actually be this.
        ...
        if (this.index[row][column] == 1) {
            this.setBackground(Color.getHSBColor(182, 33, 84)); 
            //this.setBackground(new java.awt.Color(255,0,51));
            this.setForeground(Color.BLACK);
        } else if (this.index[row][column] == 2) {
            this.setBackground(new java.awt.Color(255, 124, 30));
            this.setForeground(Color.BLACK);
        } else {
